Feature:
  ...
  Scenario: A list that does not exist
    ...
    And I should see "Contact the British embassy, high commission or consulate which represents the UK in New Zealand"
  ...
  Scenario: User cannot jump to a form page without answering the initial question
    ...
    Then I see "Apply to be added to the 'Find a lawyer abroad' service"
