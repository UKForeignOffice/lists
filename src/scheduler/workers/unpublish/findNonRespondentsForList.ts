...
import { findReminderToSend } from "./dayBefore/findReminderToSend";
import {Meta} from "./types";

export async function findNonRespondentsForList(list: List, meta: Meta) {
  return await getLists(list, meta, false);
}

export async function findNonRespondentsForListToUnpublish(list: List, meta: Meta) {
  return await getLists(list, meta, false);
}

export async function getLists(list: List, meta: Meta, isForUnpublishing: boolean) {
