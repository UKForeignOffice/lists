...
dashboardRouter.get(dashboardRoutes.listsItemsEdit, csrfRequestHandler, listItemsEditGetController);
dashboardRouter.post(dashboardRoutes.listsItemsEdit, csrfRequestHandler, listItemsEditPostController);
