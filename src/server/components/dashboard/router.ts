...
dashboardRouter.post(dashboardRoutes.listsItemDelete, csrfRequestHandler, listItemEditRequestValidation, redirectIfUnauthorised, listItemDeleteController, listItemDeleteController);
...
dashboardRouter.post(dashboardRoutes.listsItemPin, csrfRequestHandler, listItemEditRequestValidation, redirectIfUnauthorised, listItemPinController, listItemPinController);
