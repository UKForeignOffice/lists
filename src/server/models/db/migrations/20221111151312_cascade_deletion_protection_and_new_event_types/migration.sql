...
-- AlterEnum
BEGIN;
CREATE TYPE "ListItemEvent_new" AS ENUM ('NEW', 'OUT_WITH_PROVIDER', 'EDITED', 'UNPUBLISHED', 'PUBLISHED', 'PINNED', 'UNPINNED', 'DELETED', 'UNDEFINED', 'ANNUAL_REVIEW_STARTED', 'CHECK_ANNUAL_REVIEW', 'ARCHIVED');
...
-- AlterEnum
BEGIN;
CREATE TYPE "Status_new" AS ENUM ('NEW', 'OUT_WITH_PROVIDER', 'EDITED', 'PUBLISHED', 'UNPUBLISHED', 'CHECK_ANNUAL_REVIEW', 'ANNUAL_REVIEW_OVERDUE', 'OUT_FOR_ANNUAL_REVIEW');
