...
SELECT gen_random_uuid(), NOW(), 'translatorsInterpreters', missingCountries."id", '{"publishers": ["ali@cautionyourblast.com","tom.evans@fcdo.gov.uk","ros.vaughan@fcdo.gov.uk"], "validators": ["ali@cautionyourblast.com","tom.evans@fcdo.gov.uk","ros.vaughan@fcdo.gov.uk"], "administrators": ["ali@cautionyourblast.com","tom.evans@fcdo.gov.uk","ros.vaughan@fcdo.gov.uk"]}'
