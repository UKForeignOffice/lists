...
SELECT gen_random_uuid(), NOW(), 'lawyers', missingCountries."id", '{"publishers": ["ali.salaman@fcdo.gov.uk","tom.evans@fcdo.gov.uk","rosalyn.vaughan@fcdo.gov.uk"], "validators": ["ali.salaman@fcdo.gov.uk","tom.evans@fcdo.gov.uk","rosalyn.vaughan@fcdo.gov.uk"], "administrators": ["ali.salaman@fcdo.gov.uk","tom.evans@fcdo.gov.uk","rosalyn.vaughan@fcdo.gov.uk"]}'
