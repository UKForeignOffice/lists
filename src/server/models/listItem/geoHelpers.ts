// Helpers
import type { Country, Point } from "server/models/types";
...
export async function createAddressGeoLocation(item: DeserialisedWebhookData): Promise<number> {
  ...
  return rawInsertGeoLocation(point);
}
